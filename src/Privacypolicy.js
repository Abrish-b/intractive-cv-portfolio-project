...
const Privacypolicy = () => {
  return (
    <div className="px-40">
      ...
      <h2 className="text-center">What User Data We Collect</h2>
      ...
      <h2 className="text-center">Why We Collect Your Data</h2>
      ...
      <h2 className="text-center">Safeguarding and Securing the Data</h2>
      ...
      <h2 className="text-center">Our Cookie Policy</h2>
      ...
      <h2 className="text-center">Restricting the Collection of your Personal Data</h2>
